        ...
        for (Vehiculos vehiculos1 : vehiculos.LsVehiculos) {
            if (vehiculos1.getModelo().equals(modelo)) {
                ...
                if (vehiculos1.isDisponobilidad()) {
                    ...
                    vehiculos1.setDisponobilidad(false);
                    int valor= 0;
                    ...
                    return;
                        ...
                        El vehiculo no esta disponible, el cliente no ha sido registrado
    ...
    public void mostrarCLientes(){
        for (Clientes clientes : lsClientes){
            ...
            if (lsClientes.isEmpty()){
                System.out.println("no hay ningun cliente registrado por ahora");
            }
        }
    }
    ...
    public void eliminarCliente(Vehiculos vehiculos){
        ...
        for (Clientes clientes : lsClientes){
            if (clientes.getNumCedula().equals(numcedula)){
                ...
                eliminado= true;
                System.out.println("el cliente de nombre " + clientes.getNombre() + " de cedula "+ numcedula);
